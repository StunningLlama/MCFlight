...
public class CustomEntityRenderer extends EntityRenderer implements IResourceManagerReloadListener
{
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.setDetail("Screen name", new ICrashReportDetail<String>()
                    {
                        ...
                        {
                            return CustomEntityRenderer.this.mc.currentScreen.getClass().getCanonicalName();
                        }
                    });
    ...
    private void createWorldIcon()
    {
    	int chunks = 10;
		try {
			chunks = (Integer)RenderGlobal.class.getMethod("getRenderedChunks").invoke(this.mc.renderGlobal);
        ...
        if (chunks > 10 && this.mc.renderGlobal.hasNoChunkUpdates() && !this.mc.getIntegratedServer().isWorldIconSet())
        {
