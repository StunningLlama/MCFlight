...
public class GuiAirplane extends GuiContainer
{
    ...
    private final EntityAirplane horseEntity;
    /** The mouse x-position recorded during the last rendered frame. */
    private float mousePosx;
    /** The mouse y-position recorded during the last renderered frame. */
    private float mousePosY;

    public GuiAirplane(IInventory playerInv, IInventory horseInv, EntityAirplane horse)
    {
        super(new ContainerAirplane(playerInv, horseInv, horse, Minecraft.getMinecraft().player));
