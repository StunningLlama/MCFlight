...
public class ModelBiplane extends ModelBase
{
	...
	public ModelBiplane()
	{
		...
		WingTop = new BiplaneModelRenderer(this, 0, 128);
		...
		WingBottom = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevatorLeft = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevatorLeftAlt = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevatorRight = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevatorRightAlt = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevatorR = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevatorL = new BiplaneModelRenderer(this, 0, 128);
		...
		Rudder = new BiplaneModelRenderer(this, 0, 128);
		...
		RudderTri1 = new BiplaneModelRenderer(this, 0, 128);
		...
		RudderTri2 = new BiplaneModelRenderer(this, 0, 128);
		...
		RudderTri3 = new BiplaneModelRenderer(this, 0, 128);
		...
		AlieronL = new BiplaneModelRenderer(this, 0, 128);
		...
		AlieronR = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevModelL = new BiplaneModelRenderer(this, 0, 128);
		...
		ElevModelR = new BiplaneModelRenderer(this, 0, 128);
